...
!(function (i) {
  ...
  function s(i, t, o) {
    ...
    t.originalEvent.changedTouches &&
      ...
      i.parent().is(".minicolors-slider-wheel") &&
        ...
        0 > m && (m += 2 * Math.PI),
        p > 75 &&
          ((p = 75), (l = 75 - 75 * Math.cos(m)), (h = 75 - 75 * Math.sin(m))),
        (l = Math.round(l)),
        (h = Math.round(h))),
  ...
  function a(i, t) {
      ...
      switch (v.control) {
        ...
        case "saturation":
          (n = u(parseInt(S.x * (360 / y.width()), 10), 0, 360)),
            ...
            (g = m({ h: n, s: s, b: a })),
            M.css("backgroundColor", m({ h: n, s: 100, b: a })),
    ...
    t.is(".minicolors-opacity-slider") &&
      ((p = v.opacity ? parseFloat(1 - D.y / w.height()).toFixed(2) : 1),
      v.opacity && i.attr("data-opacity", p)),
      b.find("SPAN").css({ backgroundColor: g, opacity: p }),
      r(i, g, p);
  }
  function e(i, t) {
    var o,
      ...
      C = M.find("[class$=-picker]");
    switch (
      ((o = h(d(i.val(), !0), p.letterCase)),
      o || (o = h(d(p.defaultValue, !0), p.letterCase)),
      (n = f(o)),
      t || i.val(o),
      p.opacity &&
        ((s =
      ...
      case "wheel":
        (c = u(Math.ceil(0.75 * n.s), 0, b.height() / 2)),
          ...
          "" === o && (e = 0),
          x.css("top", e + "px"),
          y.css("backgroundColor", m({ h: n.h, s: n.s, b: 100 }));
        break;
      case "saturation":
        (a = u((5 * n.h) / 12, 0, 150)),
          (e = u(
          ...
          x.css("top", e + "px"),
          y.css("backgroundColor", m({ h: n.h, s: 100, b: n.b })),
      ...
      default:
        (a = u(Math.ceil(n.s / (100 / b.width())), 0, b.width())),
          ...
          x.css("top", e + "px"),
          b.css("backgroundColor", m({ h: n.h, s: 100, b: 100 }));
    }
